...
def sign_token(payload: dict) -> str:
    ...
    sig = hmac.new(APP_SECRET, body, hashlib.sha256).digest()
...
def verify_token(token: str) -> Optional[dict]:
    try:
        ...
        expected_sig = hmac.new(APP_SECRET, body, hashlib.sha256).digest()
...
def bearer_payload(req: Request) -> Optional[dict]:
